...
const DEFAULT_DATA = {
  ...
  "about": {
    ...
    "info": {
      ...
      "学历": "本科",
      "专长": "AIGC",
      "工作经历": "2024-2025望野设计工作室平面设计+AIGC视频工程师",
      "科研经历": "",
      "获奖": ""
    }
  },
...
function renderWorkCards(category) {
  ...
  grid.innerHTML = filtered.map(w => {
    ...
    const rawThumb = isVideo ? '' : (w.images?.[0] || '');
    const cardThumb = rawThumb ? thumbUrl(rawThumb) : (isVideo ? 'data:image/svg+xml,' + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300"><rect fill="%23111" width="400" height="300"/><text x="200" y="140" text-anchor="middle" font-family="sans-serif" font-size="48" fill="%23a78bfa">▶</text><text x="200" y="180" text-anchor="middle" font-family="sans-serif" font-size="12" fill="%23666">视频</text></svg>') : phImg);
